function [keypoints_matched, n_matches] = MatchedPoints(img0,img1)
%% parameters
corner_patch_size = 9;
harris_kappa = 0.08;
num_keypoints = 400;
...
keypoints_matched=zeros(4,n_matches);
c=1;

for i = 1:200
    if matches(i) ~= 0
        keypoints_matched(1:2, c) = keypoints_0(:,matches(i));
        keypoints_matched(3:4, c) = keypoints_1(:,i);
        c=c+1;
    end
end
